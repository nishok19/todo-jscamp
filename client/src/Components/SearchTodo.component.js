...
function SearchTodo() {
  ...
  const searchText = async () => {
    // TODO: Succcesssssssssssssssfulllllllllllllly able to find text in client side, now need to be implemented in the UI
  ...
  return (
    <div className="flex">
      ...
      <input
        ...
        className="input input-bordered bg-bgdark input-info w-full max-w-xs ml-4"
        value={searchingText}
